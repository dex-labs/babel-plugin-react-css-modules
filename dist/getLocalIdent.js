...
const escapeLocalIdent = localident => escape(localident
...
function getLocalIdent(loaderContext, localIdentName, localName, {
  ...
  return escapeLocalIdent((0, _cssLoader.defaultGetLocalIdent)({
    _compilation: {
      getPath
    },
    _compiler: {
      webpack: {
        ...
        util: {
          createHash: _createHash.default
        }
      }
    },
    ...
    ...loaderContext
  }, localIdentName, localName, options)).replace(/\\\[local\\]/gi, clazz);
}
